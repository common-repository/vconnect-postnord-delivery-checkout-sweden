<?php
if (!class_exists('WC_VC_NO_Private')) {

    class WC_VC_NO_Private extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be uunique.
        public $vc_aino_id = 'vconnect_postnord_no_private';
        // Title shown in admin
        public $vc_aino_type = 'mailboxDelivery';
        // Title shown in admin
        protected $vc_aino_method_title = 'Varubrev NO';
