<?php
if (!class_exists('WC_VC_World_Privatehome')) {

    class WC_VC_World_Privatehome extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be uunique.
        public $vc_aino_id = 'vconnect_postnord_world_privatehome';
