...
class Vc_Aino_Scripts {
    ...
    public function enqueue_scripts() {
        if (is_checkout() && get_option('vc_aino_license_status') == 1) {
            ...
            wp_enqueue_script('vc_aino_widget', AINO_PLUGIN_URL . '/core/widget/scripts/vconnect.allinone.min.js', array('vc_aino_gmaps'), AINO_PLUGIN_VERSION);
    ...
    private function get_js_params() {
        $result = array(
            ...
            'wc_ajax' => '?wc-ajax=aino_get_widget',
            'wc_points' => '?wc-ajax=aino_get_points',
            'wc_change_rate' => '?wc-ajax=aino_change_rate',
